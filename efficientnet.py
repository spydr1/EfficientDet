...
def mb_conv_block(inputs, block_args, activation, drop_rate=None, prefix='', freeze_bn=False):
    ...
    if block_args.expand_ratio != 1:
        ...
        x = layers.BatchNormalization(trainable=not freeze_bn, axis=bn_axis, name=prefix + 'expand_bn')(x)
    ...
    x = layers.BatchNormalization(trainable=not freeze_bn, axis=bn_axis, name=prefix + 'bn')(x)
    ...
    x = layers.BatchNormalization(trainable=not freeze_bn, axis=bn_axis, name=prefix + 'project_bn')(x)
...
def EfficientNet(width_coefficient,
    ...
    x = layers.Conv2D(round_filters(32, width_coefficient, depth_divisor), 3,
                      ...
                      kernel_initializer=CONV_KERNEL_INITIALIZER,
                      name='stem_conv')(x)
    x = layers.BatchNormalization(trainable=not freeze_bn, axis=bn_axis, name='stem_bn')(x)
