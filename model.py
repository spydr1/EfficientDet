...
def DepthwiseConvBlock(kernel_size, strides, name, freeze_bn=False):
    ...
    f2 = layers.BatchNormalization(trainable=not freeze_bn, name='{}_bn'.format(name))
...
def efficientdet(phi, num_classes=20, num_anchors=9, weighted_bifpn=False, freeze_bn=False,
                 ...
                 detect_quadrangle=False, anchor_parameters=None,preprocessing_in_gpu=False,nms_threshold=0.5):
